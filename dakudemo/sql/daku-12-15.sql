...
) ENGINE = InnoDB AUTO_INCREMENT = 166 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '审批流程表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `approve` VALUES (164, 'RK2047001', 3, 3, 29, 0, 47, 1, 1, '2022-10-16 04:38:17', '');
INSERT INTO `approve` VALUES (165, 'RK2048001', 3, 3, 29, 0, 47, 1, 1, '2022-10-16 04:50:55', '');
INSERT INTO `approve` VALUES (166, 'CK20221215580', 0, 1, 51, 6, 58, 1, 1, '2022-12-15 03:59:27', '');
INSERT INTO `approve` VALUES (167, 'CK20221215580', 0, 1, 51, 6, NULL, 2, 0, NULL, NULL);
...
CREATE TABLE `borrow_document`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '借用单单据信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `check_repair_document`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '报检报修单单据信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `department`  (
  ...
  `description` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '部门信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `device` VALUES (13, '1', '1', 40, 0, 0, 0, 0, 2, 1, '1-1-1', '台', '2022-09-28 17:46:52', 'xx', 'ww', 1.00, '', 'S-ZS-01-7826349827091');
INSERT INTO `device` VALUES (14, 'kiki', 'kiki', 10, 0, 0, 0, 0, 2, 1, '11111', '台', '2022-10-15 14:36:40', '1111', '111111', 10000.00, '', 'S-ZS-01-2222222222222');
...
CREATE TABLE `document_device`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 300 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '单据相关物品信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `document_device` VALUES (297, 'RK2047001', 'S-ZS-01-2222222222222', 10, NULL, '');
INSERT INTO `document_device` VALUES (299, 'RK2048001', 'S-ZS-01-1111111111111', 100, NULL, '');
INSERT INTO `document_device` VALUES (300, 'CK20221215580', 'S-ZS-01-2222222222222', 2, NULL, '');
...
CREATE TABLE `inout_warehouse_document`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '出入库单据表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `inout_warehouse_document` VALUES (36, 'CK20221215580', 1, 51, '2022-12-15 15:58:57', '123', 0, 1, '', NULL);
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user` VALUES (58, 'jgy', '5b1650ef42749e25abdfb2d14c92f761', '经管员', '2022-12-15 15:44:25', NULL);
